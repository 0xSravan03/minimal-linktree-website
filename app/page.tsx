  ...
  return (
    <div className="flex items-center justify-center w-full mx-auto mt-16 flex-col px-10">
      ...
      <div className="flex items-center justify-center gap-6 mt-4">
        {data.socials.map((social: SocialType) => {
          if (social.url.includes("twitter")) {
            return <a href={social.url} className="hover:scale-110"><TwitterIcon /></a>;
          }
          if (social.url.includes("github")) {
            return <a href={social.url} className="hover:scale-110"><GitHubIcon /></a>;
          }
        })}
      </div>
